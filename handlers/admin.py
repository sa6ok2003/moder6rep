...
import sqlite3
from .sqlit import info_members, reg_one_channel, reg_channels,del_one_channel,cheak_traf,obnovatrafika,reg_admin,list_adminov,obnovatrafika2,cheak_traf2,cheak_person,obnova_pers,info_chyornaya_vdova,info_good_film1,info_films_online_everyday
